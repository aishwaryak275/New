...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        createRole("S",   perms.apply(new String[]{"VIEW_PLAN", "PAY_BILL", "RAISE_SERVICE_REQUEST","USAGE_RECORDS","GET_SUB","CREATE_SUB","VIEW_INVOICE","BILLING_DISPUTE","MARK_NOTIFICATIONS","VIEW_NOTIFICATIONS","VIEW_OWN_PLAN"}));
        ...
        createRole("C",   perms.apply(new String[]{"VIEW_REPORTS","USAGE_RECORDS","USAGE_ANALYTICS","VIEW_PLAN","GET_SUB","VIEW_NOTIFICATIONS",
