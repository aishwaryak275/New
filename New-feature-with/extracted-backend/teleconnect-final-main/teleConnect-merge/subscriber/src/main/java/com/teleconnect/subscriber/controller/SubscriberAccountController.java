...
public class SubscriberAccountController {
    ...
    @PreAuthorize("hasAnyAuthority('VIEW_SUBSCRIBER', 'GET_SUB')")
    ...
    @GetMapping
    @PreAuthorize("hasAnyAuthority('VIEW_SUBSCRIBER', 'VIEW_OWN_PLAN', 'GET_SUB')")
    ...
    @PreAuthorize("hasAnyAuthority('KYC_EXPIRE', 'GET_SUB')")
    ...
    @PreAuthorize("hasAnyAuthority('VIEW_KYC', 'GET_SUB')")
